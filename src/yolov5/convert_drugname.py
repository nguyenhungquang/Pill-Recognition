...
for set_data in ["public_train"]:#, "public_test"]:
    if set_data == "public_train":
        ...
        s = "val"
    path = "../VAIPE/{}/prescription/".format(set_data)
